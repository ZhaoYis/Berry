    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("namespace Berry.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                ...
                sb.Append("    [Table(\""+ multiTableConfigModel.DataBaseTableName + "\")]");
                if (isChildTable)
                {
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using Berry.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace Berry.Entity.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c) 2017-2018\r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Berry.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Berry.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace Berry.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2017-2018\r\n");
            ...
            sb.Append("        public IEnumerable<" + multiTableConfigModel.EntityClassName + "> GetPageList(PaginationEntity pagination, string queryJson)\r\n");
            sb.Append("        {\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace Berry.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2017-2018\r\n");
            ...
            sb.Append("        /// <param name=\"queryJson\">查询参数</param>\r\n");
            sb.Append("        /// <returns>返回分页列表</returns>\r\n");
            sb.Append("        IEnumerable<" + multiTableConfigModel.EntityClassName + "> GetPageList(PaginationEntity pagination, string queryJson);\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using Berry.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Berry.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Berry.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Berry.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace Berry.BLL." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2017-2018\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Berry.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Berry.BLL." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Berry.Util;\r\n");
            sb.Append("using Berry.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace Berry.App.Admin.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2017-2018\r\n");
            ...
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            sb.Append("    public class " + multiTableConfigModel.ControllerName + " : BaseController\r\n");
            sb.Append("    {\r\n");
