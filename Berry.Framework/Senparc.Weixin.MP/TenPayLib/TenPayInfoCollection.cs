...
namespace Senparc.Weixin.MP.TenPayLib
{
    ...
    public class TenPayInfoCollection : Dictionary<string, TenPayInfo>
    {
        ...
        public static void Register(TenPayInfo weixinPayInfo, string name)
        {
            ...
            {
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].WeixinPay_PartnerId = weixinPayInfo.PartnerId;
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].WeixinPay_Key = weixinPayInfo.Key;
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].WeixinPay_AppId = weixinPayInfo.AppId;
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].WeixinPay_AppKey = weixinPayInfo.AppKey;
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].WeixinPay_TenpayNotify = weixinPayInfo.TenPayNotify;
            }
        }
