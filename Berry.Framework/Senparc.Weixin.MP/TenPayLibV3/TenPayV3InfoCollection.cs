...
namespace Senparc.Weixin.MP.TenPayLibV3
{
    ...
    public class TenPayV3InfoCollection : Dictionary<string, TenPayV3Info>
    {
        ...
        public static void Register(TenPayV3Info tenPayV3Info,string name)
        {
            ...
            {
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].TenPayV3_AppId = tenPayV3Info.AppId;
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].TenPayV3_AppSecret = tenPayV3Info.AppSecret;
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].TenPayV3_MchId = tenPayV3Info.MchId;
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].TenPayV3_Key = tenPayV3Info.Key;
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].TenPayV3_TenpayNotify = tenPayV3Info.TenPayV3Notify;
                Senparc.Weixin.WxConfig.SenparcWeixinSetting.Items[name].TenPayV3_WxOpenTenpayNotify = tenPayV3Info.TenPayV3_WxOpenNotify;
            }
        }
