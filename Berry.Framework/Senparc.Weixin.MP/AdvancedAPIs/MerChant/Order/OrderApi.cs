...
namespace Senparc.Weixin.MP.AdvancedAPIs.MerChant
{
    ...
    public static class OrderApi
    {
        ...
        {
            var urlFormat = WxConfig.ApiMpHost + "/merchant/order/getbyid?access_token={0}";
        ...
        {
            var urlFormat = WxConfig.ApiMpHost + "/merchant/order/getbyfilter?access_token={0}";
        ...
        {
            var urlFormat = WxConfig.ApiMpHost + "/merchant/order/setdelivery?access_token={0}";
        ...
        {
            var urlFormat = WxConfig.ApiMpHost + "/merchant/order/close?access_token={0}";
