...
namespace Senparc.Weixin.MP.AdvancedAPIs
{
    public static class OAuthApi
    {
        ...
        {
            var url =
                string.Format(WxConfig.ApiMpHost + "/sns/oauth2/access_token?appid={0}&secret={1}&code={2}&grant_type={3}",
        ...
        {
            var url =
                string.Format(WxConfig.ApiMpHost + "/sns/oauth2/refresh_token?appid={0}&grant_type={1}&refresh_token={2}",
        ...
        {
            var url = string.Format(WxConfig.ApiMpHost + "/sns/userinfo?access_token={0}&openid={1}&lang={2}", oauthAccessToken.AsUrlData(), openId.AsUrlData(), lang.ToString("g").AsUrlData());
        ...
        {
            var url = string.Format(WxConfig.ApiMpHost + "/sns/auth?access_token={0}&openid={1}", oauthAccessToken.AsUrlData(), openId.AsUrlData());
