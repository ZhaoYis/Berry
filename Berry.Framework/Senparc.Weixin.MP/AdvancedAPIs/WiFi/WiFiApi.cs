...
namespace Senparc.Weixin.MP.AdvancedAPIs
{
    ...
    public static class WiFiApi
    {
        ...
        /// <returns></returns>
        public static WiFiShopListJsonResult ShopList(string accessTokenOrAppId, int pageIndex = 1, int pageSize = 10, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/shop/list?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WiFiShopGetJsonResult ShopGet(string accessTokenOrAppId, long shopId, int pageindex = 1, int pagesize = 10, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/shop/get?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult ShopUpdate(string accessTokenOrAppId, long shopId, string oldSsid, string ssid, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/shop/update?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult ShopClean(string accessTokenOrAppId, long shopId, string ssid, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/shop/clean?access_token={0}";
                var data = new object();
        ...
        public static WxJsonResult AddDevice(string accessTokenOrAppId, long shopId, string ssid, string password,
            /*string bssid,*/ int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/device/add?access_token={0}";
           ...
           int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/apportal/register?access_token={0}";
        ...
        public static GetDeviceListResult GetDeviceList(string accessTokenOrAppId, int pageIndex = 1, int pageSize = 10,
            long? shopId = null, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/device/list?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult DeleteDevice(string accessTokenOrAppId, string bssid, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/device/delete?access_token={0}";
            ...
            int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/qrcode/get?access_token={0}";
            ...
            int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/homepage/set?access_token={0}";
            ...
            int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/homepage/get?access_token={0}";
            ...
            int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/bar/set?access_token={0}";
            ...
            int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/finishpage/set?access_token={0}";
            ...
            int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/couponput/set?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WiFiGetCouponPutJsonResult GetCouponPut(string accessTokenOrAppId, long shopId, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/couponput/get?access_token={0}";
        ...
        public static WiFiConnectUrlResultJson GetConnectUrl(string accessTokenOrAppId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/account/get_connecturl?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WiFiOpenPluginTokenJsonResult OpenPluginToken(string accessTokenOrAppId, string callBackUrl, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/openplugin/token?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static async Task<WiFiShopListJsonResult> ShopListAsync(string accessTokenOrAppId, int pageIndex = 1, int pageSize = 10, int timeOut = WxConfig.TIME_OUT)
        {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static async Task<WiFiShopGetJsonResult> ShopGetAsync(string accessTokenOrAppId, long shopId, int pageindex = 1, int pagesize = 10, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/shop/get?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static async Task<WxJsonResult> ShopUpdateAsync(string accessTokenOrAppId, long shopId, string oldSsid, string ssid, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/shop/update?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static async Task<WxJsonResult> ShopCleanAsync(string accessTokenOrAppId, long shopId, string ssid, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/shop/clean?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static async Task<WxJsonResult> DeleteDeviceAsync(string accessTokenOrAppId, string bssid, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/device/delete?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static async Task<WiFiGetCouponPutJsonResult> GetCouponPutAsync(string accessTokenOrAppId, long shopId, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/couponput/get?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static async Task<WiFiOpenPluginTokenJsonResult> OpenPluginTokenAsync(string accessTokenOrAppId, string callBackUrl, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                string urlFormat = WxConfig.ApiMpHost + "/bizwifi/openplugin/token?access_token={0}";
