...
namespace Senparc.Weixin.MP.CommonAPIs
{
    ...
    public static class CommonJsonSend
    {
        ...
        public static WxJsonResult Send(string accessToken, string urlFormat, object data, CommonJsonSendType sendType = CommonJsonSendType.POST,
            int timeOut = WxConfig.TIME_OUT, bool checkValidationResult = false, JsonSetting jsonSetting = null/*, int retry40001ErrorTimes = 0*/)
        {
        ...
        public static T Send<T>(string accessToken, string urlFormat, object data, CommonJsonSendType sendType = CommonJsonSendType.POST, int timeOut = WxConfig.TIME_OUT, bool checkValidationResult = false, JsonSetting jsonSetting = null)
        {
        ...
        public static async Task<WxJsonResult> SendAsync(string accessToken, string urlFormat, object data, CommonJsonSendType sendType = CommonJsonSendType.POST, int timeOut = WxConfig.TIME_OUT)
        {
        ...
        public static async Task<T> SendAsync<T>(string accessToken, string urlFormat, object data, CommonJsonSendType sendType = CommonJsonSendType.POST, int timeOut = WxConfig.TIME_OUT, bool checkValidationResult = false,
