...
namespace Berry.Util
{
    ...
    {
        /// <summary>
        /// RSA的容器 可以解密的源字符串长度为 DW_KEY_SIZE/8-11 
        /// </summary>
        private const int DW_KEY_SIZE = 1024;
        ...
        public static RSAKey GetRSAKey()
        {
            ...
            //声明一个指定大小的RSA容器
            RSACryptoServiceProvider rsaProvider = new RSACryptoServiceProvider(DW_KEY_SIZE);
            //取得RSA容易里的各种参数
        ...
        #region 检查明文的有效性 DW_KEY_SIZE/8-11 长度之内为有效 中英文都算一个字符
        /// <summary>
        ...
        {
            return (DW_KEY_SIZE / 8 - 11) >= source.Length;
        }
        #endregion
