...
namespace Berry.Util
{
    ...
    /// 文件操作帮助类
    /// </summary>
    public sealed class DirFileHelper
    {
        #region 检测指定目录是否存在
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            using (StreamWriter sw = new StreamWriter(MapPath(dir), false, System.Text.Encoding.GetEncoding("GB2312")))
            {
                sw.Write(pagestr);
                sw.Close();
            }
        ...
        public static void MoveFile(string dir1, string dir2)
        {
            dir1 = dir1.Replace("/", "\\");
            dir2 = dir2.Replace("/", "\\");
            if (System.IO.File.Exists(MapPath(dir1)))
                System.IO.File.Move(MapPath(dir1), MapPath(dir2));
        }
        ...
        public static void CopyFile(string dir1, string dir2)
        {
            ...
            if (System.IO.File.Exists(MapPath(dir1)))
            {
                System.IO.File.Copy(MapPath(dir1), MapPath(dir2), true);
            }
        }
